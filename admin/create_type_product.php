                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="process/type.php">
                            <div class="form-group">
                                ...
                                <input id="tipe" name="tipe" type="text" required="required" class="form-control">
                            </div>
                            <div class="form-group d-flex justify-content-end">
                                <button name="type_create" type="submit" class="btn btn-primary">Tambah Jenis Produk</button>
                            </div>
                        </form>
                    </div>
                </div>
